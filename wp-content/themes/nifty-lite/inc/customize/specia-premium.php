	...
	public $type = 'upgrade_premium';
	   ...
	   function render_content() {
		?>
			...
			<div>
				<ul>
					<li><a href="http://docs.speciatheme.com/themes/nifty/" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/documentation.png"></a></li>
					
					<li><a href="https://wordpress.org/support/theme/nifty-lite/reviews/#new-post" target="_blank"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/rating.png"></a></li>
				</ul>
			</div>
		<?php
	   }
