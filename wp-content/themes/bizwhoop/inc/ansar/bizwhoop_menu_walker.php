<?php 
function bizwhoop_page_menu_args( $args ) {
	if ( ! isset( $args['show_home'] ) )
		$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'bizwhoop_page_menu_args' );

 
function bizwhoop_fallback_page_menu( $args = array() ) {
...
class bizwhoop_walker_page_menu extends Walker_Page{
